...
FINAL_URL = 'https://slt.bio/yenniwhi'
...
<script>
  ...
  function unlock() {
    if (isAndroid) {
      ...
      status.className   = 'status holding';
      window.location.href = 'intent://slt.bio/yenniwhi#Intent;scheme=https;package=com.android.chrome;end';
    } else {
